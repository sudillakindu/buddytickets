...
function SectionHeader({ highlight, title, link }: SectionHeaderProps) {
  ...
  return (
    <div className="flex flex-row items-center justify-between mb-8">
      ...
      >
        <h2 className="font-primary font-semibold text-2xl md:text-[30px] text-[hsl(222.2,47.4%,11.2%)]">
...
export default function FeaturedEvents() {
  ...
  return (
    <section 
      id="events" 
      className="py-16 md:py-20 relative overflow-hidden bg-gradient-to-b from-white to-[hsl(210,40%,96.1%)]"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 space-y-16 [&_.event-title]:font-primary [&_.event-category]:font-primary [&_.event-price]:font-primary [&_.event-button]:font-primary [&_.event-meta]:font-secondary [&_.event-overlay]:font-secondary [&_.event-location]:font-secondary [&_.event-label]:font-secondary">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20 text-[hsl(215.4,16.3%,46.9%)]">
            <Loader2 className="w-8 h-8 animate-spin relative z-10 text-[hsl(270,70%,50%)]" />
          </div>
        ) : eventsList.length === 0 ? (
          <motion.div
          ...
          >
            ...
            <h3 className="font-primary text-2xl font-semibold text-[hsl(222.2,47.4%,11.2%)] mb-2">
              No Events Right Now
            </h3>
            <p className="font-secondary text-[hsl(215.4,16.3%,46.9%)] max-w-md mx-auto">
