    ...
    >
      ...
      <div className="px-5 sm:px-6 py-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex items-center gap-2">
            <Clock className="w-3.5 h-3.5 text-[hsl(270,70%,50%)] shrink-0" aria-hidden="true" />
            <span className="font-secondary text-xs text-[hsl(222.2,47.4%,11.2%)]">
          ...
          <div className="flex items-center gap-2 col-span-2">
            <MapPin className="w-3.5 h-3.5 text-[hsl(270,70%,50%)] shrink-0" aria-hidden="true" />
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <Tag className="w-3.5 h-3.5 text-[hsl(270,70%,50%)]" aria-hidden="true" />
