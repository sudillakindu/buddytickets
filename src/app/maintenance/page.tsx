...
export default function MaintenancePage() {
  ...
  const springY = useSpring(
    useTransform(mouseY, (v: number) => v * 0.05),
    SPRING_CONFIG,
  );
        ...
        >
          ...
          >
            ...
            <p className="font-secondary text-gray-500 mt-3 mb-8 text-sm sm:text-base leading-relaxed max-w-lg mx-auto">
              BuddyTickets is currently undergoing scheduled maintenance to
              improve your experience. Please grab a cup of coffee and check
