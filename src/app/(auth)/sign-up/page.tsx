...
const INPUT_CLASS = "font-secondary pl-10 h-11 rounded-xl border-[hsl(222.2,47.4%,11.2%)]/15 focus-visible:border-[hsl(270,70%,50%)] focus-visible:ring-[hsl(270,70%,50%)]/20 bg-[hsl(210,40%,98%)]";
const LABEL_CLASS = "font-primary text-xs font-semibold uppercase tracking-wide text-[hsl(222.2,47.4%,11.2%)]";
                    ...
                    <motion.div className="space-y-1.5" {...fadeUp(0.19)}>
                        ...
                        <div className="relative">
                            ...
                            <Input id="confirm" name="confirm" type={showConfirm ? 'text' : 'password'}
                                ...
                                className={`${INPUT_CLASS} pr-11 ${form.confirm && form.password !== form.confirm ? 'border-red-400 focus-visible:border-red-400 focus-visible:ring-red-400/20' : ''}`} />
