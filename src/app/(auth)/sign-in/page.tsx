...
export default function SignInPage() {
  ...
  const handleGoogleSignIn = () => {
    Toast('Coming Soon', 'Google sign-in is launching soon!', 'default');
  };
      ...
      <div className="bg-white/80 backdrop-blur-xl border border-white/60 shadow-2xl shadow-[hsl(222.2,47.4%,11.2%)]/5 rounded-3xl p-6 sm:p-10">
        ...
        >
          ...
          <p className="font-secondary text-sm text-[hsl(215.4,16.3%,46.9%)]">
            Sign in to your BuddyTicket account
          </p>
        </motion.div>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="font-secondary text-xs text-[hsl(270,70%,50%)] hover:text-[hsl(270,70%,40%)] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
        ...
        >
          <Button
            ...
            className="font-primary w-full h-11 rounded-xl text-sm border-[hsl(222.2,47.4%,11.2%)]/15 text-[hsl(222.2,47.4%,11.2%)] bg-white hover:bg-[hsl(210,40%,98%)] transition-colors flex items-center justify-center gap-2.5"
          >
