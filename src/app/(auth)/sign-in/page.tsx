        ...
        >
            <div className="bg-white/80 backdrop-blur-xl border border-white/60 shadow-2xl shadow-[hsl(222.2,47.4%,11.2%)]/5 rounded-3xl px-8 py-10 sm:px-10">
                ...
                <motion.div className="mb-8 text-center" {...fadeUp(0.05)}>
                    ...
                    <h1 className="font-special text-3xl font-semibold text-[hsl(222.2,47.4%,11.2%)] mb-1.5">Welcome back</h1>
                ...
                <motion.div {...fadeUp(0.3)}>
                    <Button
                        ...
                        className="font-primary w-full h-11 rounded-xl text-sm border-[hsl(222.2,47.4%,11.2%)]/15 text-[hsl(222.2,47.4%,11.2%)] bg-white hover:bg-[hsl(210,40%,98%)] transition-colors flex items-center gap-2.5"
                    >
