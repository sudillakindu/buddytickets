...
function VerifyEmailForm() {
  ...
  if (pageError) return <ErrorCard message={pageError} onRetry={loadSessionData} />;

  const pageTitle = purpose === 'forgot-password' ? 'Reset Your Password' : 'Verify Your Email';
  const submitLabel = purpose === 'forgot-password' ? 'Verify & Continue' : 'Verify Email';
