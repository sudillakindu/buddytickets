...
function ForgotPasswordForm() {
  ...
  return (
    <div className="min-h-[100dvh] w-full flex items-center justify-center relative overflow-x-hidden overflow-y-auto bg-gradient-to-b from-[hsl(210,40%,96.1%)] to-white py-10 px-4 sm:px-6">
      <AuthBackground />
