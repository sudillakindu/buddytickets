...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="min-h-screen supports-[min-height:100dvh]:min-h-[100dvh] bg-gradient-to-br from-[hsl(210,40%,96.1%)] via-white to-[hsl(270,70%,97%)] flex flex-col relative z-0">
            ...
            <header className="w-full px-6 py-4">
                ...
                >
                    <Link href="/" className="inline-flex items-center gap-2.5 group" aria-label="BuddyTickets home">
                        <Image src={Logo} alt="BuddyTickets" width={32} height={32} className="rounded-lg w-8 h-8" />
