  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        logger.error({ fn: "TicketsPage.load", message: "Failed to load tickets", meta: error });
        if (!cancelled) Toast("Connection Error", "Failed to load tickets. Please check your connection.", "error");
      } finally {
