...
const AvatarSection: React.FC<AvatarSectionProps> = memo(
  ({ profile, onImageChange }) => {
    ...
    const handleFileSelect = useCallback(
      async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
          ...
          logger.error({
            fn: "ProfilePage.handleFileSelect",
...
const EditProfileForm: React.FC<EditProfileFormProps> = memo(
  ({ profile, onSuccess }) => {
...
const ChangePasswordForm: React.FC<{ onCancel: () => void }> = memo(
  ({ onCancel }) => {
...
const ProfilePageSkeleton: React.FC = memo(() => (
  <div
