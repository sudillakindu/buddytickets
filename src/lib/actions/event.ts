...
const EVENT_CARD_SELECT = `
  ...
  platform_fee_value, platform_fee_cap,
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .select(
        ...
        is_active, is_vip, platform_fee_value, platform_fee_cap,
        allowed_payment_methods, created_at, updated_at,
    ...
    const event: EventDetails = {
      ...
      is_vip: data.is_vip,
      platform_fee_value: data.platform_fee_value != null ? Number(data.platform_fee_value) : null,
