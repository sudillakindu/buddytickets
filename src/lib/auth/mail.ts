...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width,initial-scale=1">
  <title>Welcome to BuddyTickets</title>
</head>
<body style="margin:0;padding:0;background:#f1f5f9;font-family:'Segoe UI',Arial,sans-serif;">
  <div style="padding:32px 16px;">
    <div style="max-width:520px;margin:0 auto;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 4px 24px rgba(15,23,42,0.10);border:1px solid #e2e8f0;">
      ...
      <div style="padding:36px 32px;">
        ...
        <p style="color:#94a3b8;font-size:13px;margin:0;text-align:center;line-height:1.6;">Need help getting started? <a href="mailto:${SUPPORT_EMAIL}" style="color:#7c3aed;text-decoration:none;">Contact our support team</a>. We&rsquo;re happy to help!</p>
      </div>
