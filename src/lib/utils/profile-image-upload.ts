...
function getBucketName(): string {
  ...
  if (!bucket) throw new Error('Missing NEXT_PUBLIC_SUPABASE_STORAGE_BUCKET environment variable.');
  return bucket;
}
...
export async function uploadProfileImageToStorage(file: File, userId: string): Promise<ProfileImageUploadResult> {
  try {
